...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Your ${companyName} worker portal access</title>
</head>
<body style="margin:0;padding:0;background:#f4f4f5;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f4f4f5;padding:40px 0;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          <tr>
            <td style="background:#1a1a2e;padding:32px 40px;">
              <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;">${companyName}</h1>
              <p style="margin:4px 0 0;color:#a0aec0;font-size:13px;">Worker Portal</p>
            </td>
          </tr>
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 16px;font-size:16px;color:#374151;">Hi ${firstName},</p>
              <p style="margin:0 0 16px;font-size:15px;color:#374151;line-height:1.6;">
                You have been given access to the <strong>${companyName} Worker Portal</strong> for your
                <strong>${jobRole}</strong> role. Click below to access your shifts, availability and documents.
              </p>
              <table cellpadding="0" cellspacing="0" style="margin:32px 0;">
                <tr>
                  <td style="background:#4f46e5;border-radius:6px;">
              ...
              <table cellpadding="0" cellspacing="0" style="background:#fef9c3;border-left:4px solid #f59e0b;border-radius:4px;margin:0 0 24px;width:100%;">
                <tr>
                  <td style="padding:12px 16px;">
                    <p style="margin:0;font-size:13px;color:#92400e;">
                      ⏰ &nbsp;This link expires on <strong>${expiryDate}</strong> (7 days).
                    </p>
                  </td>
                </tr>
              </table>
  ...
  const text = [
    `Hi ${firstName},`,
    '',
    `You have been given access to the ${companyName} Worker Portal for your ${jobRole} role.`,
    '',
    `Access your portal here: ${magicLink}`,
    '',
    `This link expires on ${expiryDate} (7 days).`,
    '',
    `If you were not expecting this email, you can safely ignore it.`,
    '',
    `© ${new Date().getFullYear()} ${companyName}`,
