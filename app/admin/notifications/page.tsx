...
import NotificationsDesktop from '@/components/admin/NotificationsDesktop'
...
export default function NotificationsPage() {
  ...
  return (
    <div className="h-full min-h-screen lg:min-h-0 bg-background lg:bg-transparent">
      ...
      <div className="block lg:hidden space-y-5">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-on-surface-variant mt-0.5">Recent email send attempts.</p>
          </div>
        </div>
