...
const STATUSES = [
  ...
  { value: 'ended',  label: 'Ended',   cls: 'bg-gray-50   text-gray-500   ring-gray-400/20   hover:bg-gray-100' },
] as const
      ...
      {shiftWarning && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-sm rounded-xl bg-white shadow-xl p-5 space-y-4">
            <h3 className="text-sm font-semibold text-gray-900">Unassigned future shifts exist</h3>
