...
export default function ResendInviteButton({ applicantId }: { applicantId: string }) {
  ...
  async function handleClick() {
    ...
    try {
      const res  = await fetch(`/api/admin/applicants/${applicantId}/resend-invite`, { method: 'POST' })
      ...
      setResult(data as ResendResult)
      router.refresh()
    } catch {
