...
export default function AdminSidebar({ userRole, userFullName, userInitials }: AdminSidebarProps) {
  ...
  const navItems = [
    ...
    { label: 'Archived Applicants', href: '/admin/applicants/archived', icon: 'archive', show: navCan((r) => can(r, 'applicants:read')) },
    { label: 'Onboarding',   href: '/admin/onboarding',    icon: 'how_to_reg',    show: navCan(canManageStaff) },
    { label: 'Client Registry', href: '/admin/clients', icon: 'contact_page', show: navCan((r) => can(r, 'clients:read')) },
