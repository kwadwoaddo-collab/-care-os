...
export default function AdminHeader() {
  ...
  return (
    <header className="h-16 w-full sticky top-0 z-40 bg-surface/80 dark:bg-background/80 backdrop-blur-md flex justify-between items-center px-6 transition-colors">
